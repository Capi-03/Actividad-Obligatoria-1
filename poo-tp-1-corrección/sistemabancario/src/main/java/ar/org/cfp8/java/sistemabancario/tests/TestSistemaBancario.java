...
import ar.org.cfp8.java.sistemabancario.clientes.ClienteIndividual;
...
public class TestSistemaBancario {
    public static void main(String[] args) {
        ...
        // Depósito en dólares inválido
        convertibilidad.depositarDolares(-100);
        // Extracción inválida
        convertibilidad.extraerDolares(-50);
        // Conversión con monto negativo
        convertibilidad.convertirPesosADolares(-500, 1000);
        // Conversión con tasa igual a cero
        convertibilidad.convertirPesosADolares(500, 0);
        // Conversión con tasa negativa
        convertibilidad.convertirDolaresAPesos(100, -10);
        // Conversión con saldo insuficiente
        convertibilidad.convertirDolaresAPesos(100000, 1050);
